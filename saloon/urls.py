...
urlpatterns = [
    ...
    path("playlists/sync/preview/", spotify_views.playlist_sync_preview, name="playlist_sync_preview"),
    path("playlists/sync/selected/", spotify_views.sync_selected_playlists_view, name="sync_selected_playlists"),
    path("playlists/<str:playlist_id>/ignore/", spotify_views.ignore_playlist, name="ignore_playlist"),
    ...
    path("mashup/harmonic-compare/", spotify_views.harmonic_compare, name="harmonic_compare"),
    path("mashup/harmonic-compare/status/<str:job_id>/", spotify_views.harmonic_compare_status, name="harmonic_compare_status"),
]
